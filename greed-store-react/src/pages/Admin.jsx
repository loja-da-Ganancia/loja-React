...
import { toggleUserRoleAsync, deleteUserAsync, fetchAllUsersAsync } from "../slices/userSlice";
...
export default function Admin() {
  ...
  // ====================================================
  // 3. PROTEÇÃO DE ROTA + CARREGAR USUÁRIOS DO BACKEND
  // ====================================================
  useEffect(() => {
    if (!userLogado || userLogado.role !== 'admin') {
      ...
      // Busca lista de usuários atualizada do MongoDB
  ...
  function deletarUsuario(user) {
    ...
    if (window.confirm(`Tem a certeza que deseja excluir o utilizador '${user.username}'?`)) {
      const userId = user._id || user.id;
                    ...
                    <td className="text-center">
                      <div className="d-flex justify-content-center gap-2">
                        <button 
                          ...
                          onClick={() => alternarPapelUsuario(user)}
